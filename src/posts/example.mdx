...
very positive Q4 2024 earnings report, sending the stock price to record highs,
CEO Jensen Huang had a simple message:

"Accelerated computing and generative AI have hit the tipping point"

I'm personally fully aboard the hype train, and couldn't agree more. Excited to
be working on these topics on a daily basis at
[Twice Commerce](https://twicecommerce.com) and can't wait to see what the
future holds.
