...
they need the user to tell them exactly what to do. This has always been the
role of user interfaces: bridging this communication gap by providing visual
representations of what a system can do, and how to interact with it.

![An image here](https://plus.unsplash.com/premium_photo-1708684233610-7a82720cd733?q=80&w=3174&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)
...
what the recent technological advances making them possible (if not inevitable).
